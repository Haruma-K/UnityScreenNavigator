...
namespace Demo.Core.Scripts.View.UnitTypeInformation
{
    public sealed class UnitTypeInformationViewState : AppViewState, IUnitTypeInformationState
    {
        ...
        public ReactiveProperty<string> Title => _title;
        public ReactiveProperty<int> TabIndex => _tabIndex;
        public ReactiveProperty<string> Rank1Description => _rank1Description;
        public ReactiveProperty<string> Rank2Description => _rank2Description;
        public ReactiveProperty<string> Rank3Description => _rank3Description;
        ...
        public Observable<Unit> OnExpandButtonClicked => _onExpandButtonClickedSubject;
